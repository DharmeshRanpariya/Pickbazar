...
export default function CreateOrUpdateFlashSaleForm({ initialValues }: IProps) {
  ...
  const onSubmit = async (values: FormValues) => {
    const inputValues = {
      ...
      image: values.image?.photoUrl,
      coverImage: values.coverImage?.photoUrl,
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-wrap my-5 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          {flashSaleType === FlashSaleType.FIXRATE && (
            <>
              <Alert
      ...
      {/* particular select product apply flash sale */}
      {/* <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
        <Description
