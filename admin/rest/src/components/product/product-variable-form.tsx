                ...
                (fieldAttributeValue: any, index: number) => {
                  return (
                    ...
                    >
                      ...
                      <input
                        {...register(`variationOptions.${index}.id`)}
                        type="hidden"
                      />
                      ...
                      <div className="grid grid-cols-2 gap-5">
                        <Input
                          ...
                          error={t(
                            // @ts-ignore
                            errors.variationOptions?.[index]?.price?.message,
                          )}
                          variant="outline"
                          className="mb-5"
                        />
                        <Input
                          ...
                          error={t(
                            // @ts-ignore
                            errors.variationOptions?.[index]?.sale_price
                              ?.message,
                          )}
                          variant="outline"
                          className="mb-5"
                        ...
                        <Input
                          ...
                          error={t(
                            // @ts-ignore
                            errors.variationOptions?.[index]?.sku?.message,
                          )}
                          variant="outline"
                          className="mb-5"
                        />
                        <Input
                          ...
                          error={t(
                            // @ts-ignore
                            errors.variationOptions?.[index]?.quantity?.message,
                          )}
                          variant="outline"
                          className="mb-5"
                        />
                      ...
                      <div>
                        ...
                        <FileInput
                          name={`variationOptions.${index}.image`}
                          control={control}
                          // multiple={false}
                        />
                      </div>
                      <div className="mt-5 mb-5">
                        <Checkbox
                          {...register(`variationOptions.${index}.is_digital`)}
                          label={t('form:input-label-is-digital')}
                        />
                        {!!watch(`variationOptions.${index}.is_digital`) && (
                          <div className="mt-5">
                            <Label>{t('form:input-label-digital-file')}</Label>
                            <FileInput
                              name={`variationOptions.${index}.digital_file_input`}
                              control={control}
                              multiple={false}
                              acceptFile={true}
                            ...
                            {
                              // @ts-ignore
                              errors?.variationOptions?.[index]
                                ?.digital_file_input && (
                                <ValidationError
                                  // message={t(
                                  //   errors?.variationOptions?.[index]?.digital_file_input?.original?.message
                                  // )}
                                  message={t(
                            ...
                            <input
                              type="hidden"
                              {...register(
                                `variationOptions.${index}.digital_file`,
                              )}
                            />
                          </div>
                        )}
                      ...
                      <div className="mt-5 mb-5">
                        <Checkbox
                          ...
                          error={t(
                            // @ts-ignore
                            errors.variationOptions?.[index]?.is_disable
                              ?.message,
                          )}
