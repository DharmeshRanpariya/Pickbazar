export const API_ENDPOINTS = {
  ...
  COUPONS: 'coupon',
  BROADCAST: '/broadcast/send-email',
  ...
  ME: '/users/me',
  TOKEN: 'token',
  BLOCK_USER: 'users/isActive',
  UNBLOCK_USER: 'users/isActive',
  CHANGE_PASSWORD: '/auth/change-password',
  FORGET_PASSWORD: '/auth/request-password-reset',
  VERIFY_FORGET_PASSWORD_TOKEN: '/auth/verifyForgetPasswordToken',
  ...
  ORDER_INVOICE_DOWNLOAD: 'order/bill',
  ...
  NEW_OR_INACTIVE_PRODUCTS: 'product/draft-products',
  LOW_OR_OUT_OF_STOCK_PRODUCTS: '/product/stock-status',
