    ...
    case 'color':
      return (
        ...
        <div
          ...
          onClick={onClick}
          className={cn(
            'flex items-center justify-center cursor-pointer border-2 border-transparent p-0.5',
            {
              '!border-accent': isActive,
            },
            'h-[60px] w-[60px] md:h-[80px] md:w-[80px] lg:h-[80px] lg:w-[80px]',
          )}
        >
          <span
            className="h-full w-full border border-border-200"
            style={{
