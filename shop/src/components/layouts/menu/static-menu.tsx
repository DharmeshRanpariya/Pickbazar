  ...
  return (
    <>
      ...
      <li className="menuItem group relative mx-3 cursor-pointer py-3 xl:mx-4">
        ...
        <ul className="shadow-dropDown invisible absolute top-full z-30 w-[220px] rounded-md bg-light py-4 opacity-0 shadow transition-all duration-300 group-hover:visible group-hover:opacity-100 ltr:left-[-100px] rtl:right-0 xl:w-[240px]">
          {headerLinks
